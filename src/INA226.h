...
*
* @mainpage Arduino library to support the INA226 current sensors
*
* @section Library_intro_section Description
*
* Class definition header for the INA class. This library gives a common interface to the INA226 power monitor
* device.
* The INA226 device can operate on a 3-5V power supply and can measure voltages up to 36V.
* This device works as a High-Side / Low-Side bi-directional current and power monitor
* with an I2C compatible interface. The device documentation can be found at the following location:\n
* http://www.ti.com/product/INA226/technicaldocuments\n\n
*
* @section license GNU General Public License v3.0
*
* This program is opensource software: you can redistribute it and/or modify it under the terms of the 
...
*
* Written  by Kornelius Jarzerbski
* Modified by Ernesto Lorenz
* 
* @section versions Changelog
*
* Version | Date       | Developer                          | Comments
* ------- | ---------- | ------------------------------     | --------
* 1.0.2   | 2019-09-14 | https://github.com/seurat-atreides | Issue #1. Adding INA3221 support to library
* 1.0.1   | 2017-07-31 | https://github.com/jarzebski       | Forked the code from the original GIT repo
*
*******************************************************************************************************************/
