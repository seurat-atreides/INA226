...
void checkConfig()
{
  ...
  Serial.print(ina.getMaxPossibleCurrent()*1e3,2);
  Serial.println(" mA");

  Serial.print("Max current:           ");
  Serial.print(ina.getMaxCurrent()*1e3,2);
  Serial.println(" mA");

  Serial.print("Max shunt voltage:     ");
  Serial.print(ina.getMaxShuntVoltage()*1e3,2);
  Serial.println(" mV");
...
void setup() 
{
  ...
  // Configure INA226
  ina.configure(INA226_AVERAGES_4, INA226_BUS_CONV_TIME_8244US, INA226_SHUNT_CONV_TIME_8244US, INA226_MODE_SHUNT_BUS_CONT);

  // Calibrate the device using default values defined in INA266.h
  ina.calibrate();
...
void loop()
{
  ...
  Serial.print(ina.readBusPower()*1e3, 2);
  Serial.println(" mW");


  Serial.print("Shunt voltage: ");
  Serial.print(ina.readShuntVoltage()*1e6, 2);
  Serial.println(" uV");

  Serial.print("Shunt current: ");
  Serial.print(ina.readShuntCurrent()*1e3, 2);
  Serial.println(" mA");
